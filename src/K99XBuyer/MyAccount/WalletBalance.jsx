    ...
    <>
     <section className="border rounded-2">
      ...
      <div className="p-3 d-flex flex-column align-items-center w-100">
         ...
         <button onClick={()=> setAddFunds(true)} className="btn btn-success mb-3 d-flex align-items-center w-100 justify-content-center gap-1"><IoMdAdd className="fs-5"/>Add Funds</button>
         <button onClick={()=> setWithdraw(true)}  className="btn btn-outline-secondary d-flex align-items-center w-100 justify-content-center gap-1"><FiMinus className="fs-5"/> Withdraw</button>
      </div>
     </section>
     {/* Add Funds */}
      {
