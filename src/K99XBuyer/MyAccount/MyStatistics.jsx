   ...
   <section className="rounded-3 overflow-hidden shadow-sm">
    ...
    <div className="p-3 card-bg">
        ...
        <div className="d-flex flex-column align-items-center mb-3">
            <span className=" fs-4 fw-bold secondary-color">47</span>
            <span className="text-secondary fw-bold">Total Bids</span>
        </div>
        <div className="d-flex flex-column align-items-center mb-3">
            <span className="fs-4 fw-bold secondary-color">12</span>
            <span className="text-secondary fw-bold">Won Auctions</span>
        </div>
        </div>
        <div className="d-flex justify-content-around">
        <div className="d-flex flex-column align-items-center mb-3">
            <span className="fs-4 fw-bold secondary-color">25%</span>
            <span className="text-secondary fw-bold">Win Rate</span>
        </div>
        <div className="d-flex flex-column align-items-center">
            <span className="fs-4 fw-bold secondary-color">$185K</span>
