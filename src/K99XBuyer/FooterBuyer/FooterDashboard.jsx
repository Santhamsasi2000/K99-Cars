...
const FooterDashboard = () => {
  return (
    <motion.footer className="" style={{backgroundColor: "#008cd3"}}
     initial={{ opacity: 0, y:50 }}
     whileInView={{ opacity:1, y:0 }}
     transition={{ duration: 0.6, ease: "easeOut"}}>
      {/* <div className="border"></div> */}
      <div className="text-white d-flex flex-column flex-xl-row gap-3 gap-xl-0 justify-content-around p-3 align-items-center">
