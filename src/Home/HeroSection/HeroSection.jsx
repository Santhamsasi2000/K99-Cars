...
const HeroSection = () => {
  return (
    ...
    <section className="hero-section">
      <div className="row justify-content-between align-items-end gy-4 gx-0">
        <div className="col-md-6">
            ...
            <h1 className="hero-title mb-0 text-center text-md-start">REAL TIME OFFER.</h1>
            {/* <h1 className="hero-title mb-0 text-center text-md-start">FREE PICKUP.</h1> */}
            <h1 className="hero-title mb-0 text-center text-md-start">SAME DAY PAYMENT.</h1>
