...
const HeroSection = () => {
  return (
    ...
    <section className="hero-section">
      <div className="row justify-content-between gy-4 align-items-center gx-0">
        <div className="col-md-6 justify-content-between">
            ...
            <h1 className="hero-title mb-0 text-center text-md-start">INSTANT OFFER.</h1>
            <h1 className="hero-title mb-0 text-center text-md-start">FREE PICKUP.</h1>
            <h1 className="hero-title mb-0 text-center text-md-start">FAST PAYMENT.</h1>
            <p className="mt-4 hero-subtitle fw-semibold text-center text-md-start">Sell your used, damaged, or old car easily — no agents, no hassle, no hidden fees.</p>
        </div>
        <div className="col-md-6 col-lg-5 justify-content-between">
            <CarOfferForm/>
        </div>
      </div>
    </section>
    <div className="row justify-content-end offer-btn-row gx-0">
      <div className="col-md-6 col-lg-5 ">
        <NavLink className="offer-btn w-100 rounded-bottom-4 d-flex justify-content-center align-items-center" to="/instant-offer">GET AN INSTANT OFFER
