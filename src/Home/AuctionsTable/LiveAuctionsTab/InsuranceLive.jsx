...
const title = "Insurance Claim Live Auctions ";
const subtitle = "Browse vehicles sourced from top insurance companies";
...
const InsuranceLive = () => {
  return (
    <section className="m-3 m-sm-4 m-md-5 shadow p-4 p-md-5 main-auctionCard blue-bg-50">
