...
import InsuranceLive from "./InsuranceLive";
import ConsumerLive from "./ConsumerLive";
     ...
     <section>
        ...
        <div className="d-flex justify-content-center gap-3 gap-sm-4">
            <motion.button 
                ...
                ${activeTab === "bank" ? "activeLive-subBtn" : "normalLive-subBtn"}`}
            ...
            <motion.button 
                ...
                ${activeTab === "insurance" ? "activeLive-subBtn" : "normalLive-subBtn"}`}
            ...
            <motion.button 
                ...
                ${activeTab === "consumer" ? "activeLive-subBtn" : "normalLive-subBtn"}`}
...
export default LiveAuctionsTab
