...
const title = "Bank Partnered Live Auctions";
const subtitle = "Access verified bank repossessed cars available for bidding";
...
const BankLive = () => {
  return (
    <motion.section 
      className="m-3 m-sm-4 m-md-5 shadow p-4 p-md-5 main-auctionCard blue-bg-50"
    >
      ...
      <div>
         {
            LiveData.map(( {id, event, location, startTime,  closingTime, noOfVehicles, action }, i ) => (
...
export default BankLive

const LiveData = [
    {
    id: 1,
    event: "Nissan Renault Fin-Andhra Pradesh-4W",
    location: "Andhra Pradesh",
    startTime: "22-Jul-2025 16:00",
    closingTime: "24-Jul-2025 17:50",
    noOfVehicles: 1,
    action: "Bid Now"
  },
  {
    id: 2,
    event: "Nissan Renault Fin-Bihar-4W",
    location: "Bihar",
    startTime: "22-Jul-2025 16:00",
    closingTime: "24-Jul-2025 17:50",
    noOfVehicles: 1,
